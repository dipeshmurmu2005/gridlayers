<div class="py-10 px-60">
    <div class="bg-linear-to-br from-[#000000]/4 to-[#BF40BF]/4 p-18 rounded-2xl">
        @if ($this->activeStep == null)
            <div class="flex justify-center h-120 items-center">
                <div class="w-100 p-10 bg-white rounded-xl flex flex-col items-center justify-center gap-5">
                    <div class="h-12 w-12 flex justify-center items-center rounded-full bg-black/3">
                        <x-heroicon-m-information-circle class="h-8 w-8 text-primary" />
                    </div>
                    <div class="text-center space-y-2">
                        <h2 class="font-bold">No Plan Selected</h2>
                        <p class="text-sm text-black/70">Please choose a product or plan before continuing to onboarding
                        </p>
                    </div>
                    <div>
                                ...
                                <div>
                                    <div class="bg-white p-1 rounded-2xl">
                                        ...
                                        <div class="p-5 space-y-2">
                                            ...
                                            <p class="text-sm text-black/80">In both processes, you can use a website
                                                themes
                                                or
                                            ...
                                            <div class="grid grid-cols-2 gap-5">
                                                <button class="btn bg-black/5"><x-heroicon-m-play-circle
                                                        class="h-4 w-4" />
                                                    Preview</button>
                ...
                @if ($this->activeStep == 3)
                    <div class="flex justify-center flex-col items-center gap-10">
                        <div class="w-180 grid grid-cols-2 gap-10">
                            <div
                                class="bg-white p-5 ring-2 rounded-2xl ring-primary ring-offset-5 shadow-xs space-y-5">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-black/70">Perfect for getting started instantly with no cost
                                    </p>
                                </div>
                                <div>
                                    <fieldset class="fieldset">
                                        ...
                                        <label
                                            ...
                                            <div
                                                class="border-l pl-2 font-bold border-black/10 flex gap-1 items-center">
                                                .ongridlayers.com
                                                @if ($this->subdomain)
                                        ...
                                        @if ($this->subdomain)
                                            @if ($this->subdomaintaken)
                                                <p class="label text-error text-wrap">subdomain has already been taken
                                                    type
                                                    new</p>
                                            @endif
                                        @endif
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-black/70">Connect a professional domain like .com or .org
                                    </p>
                                </div>
                        ...
                        <div class="bg-primary/5 p-8 w-180 rounded-2xl flex gap-3 items-start">
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-sm text-black/70"> If you choose a custom domain, you'll need to update
                                    your
                                    DNS
                                    records (A and CNAME) with
                                    your provider. Don't worry, we'll provide step-by-step instructions in the next
                                    step.
                            ...
                            <div class="grid grid-cols-2 gap-5">
                                <label for="billing_cycle_monthly"
                                    ...
                                    <div class="flex justify-end">
                                        <input type="radio" id="billing_cycle_monthly" value="monthly"
                                            name="radio-4" wire:model="billingCycle"
                                            class="radio radio-primary radio-sm" />
                                    </div>
                                    <div>Rs. <span class="text-4xl font-bold">499</span> /mo</div>
                                    <p class="text-sm text-black/60">This is how people will find your business online.
                                    </p>
                                </label>
                                <label for="billing_cycle_yearly"
                                    class="bg-linear-to-br from-[#BF40BF]/4 to-primary/4 p-5 rounded-xl space-y-2 cursor-pointer">
                                    <div class="flex justify-end">
                                        <input type="radio" id="billing_cycle_yearly" value="yearly"
                                            name="radio-4" wire:model="billingCycle"
                                            class="radio radio-primary radio-sm" />
                                    </div>
